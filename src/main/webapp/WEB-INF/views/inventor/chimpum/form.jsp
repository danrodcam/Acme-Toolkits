...
<acme:form>
	...
	<acme:input-textbox readonly="true" code="inventor.chimpum.form.label.creation-moment" path="creationMoment"/>
	...
	<acme:input-textbox code="inventor.chimpum.form.label.initialDate" path="initialDate"/>
	<acme:input-textbox code="inventor.chimpum.form.label.finalDate" path="finalDate"/>
	<acme:input-money code="inventor.chimpum.form.label.budget" path="budget"/>
	<acme:input-url code="inventor.chimpum.form.label.optional-link" path="optionalLink"/>
	<jstl:choose>	 
